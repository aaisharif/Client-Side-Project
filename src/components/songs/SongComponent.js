...
import { BsTrash, BsFillTrashFill, BsHeart, BsHeartFill, BsPlayCircle, BsPlayCircleFill } from "react-icons/bs";
import './Song.css'
    ...
    return (
        <>
            ...
            <div className="PlayButton">
                {modeButton ?
                    (<BsPlayCircleFill size={75} color={'lightblue'} onClick={handleOnClick2} />)
                    :
